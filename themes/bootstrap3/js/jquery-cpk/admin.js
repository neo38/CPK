...
(function() {
    ...
    function ApprovalController() {
		...
		function resolveInitDom( result ) {
			...
			return Promise.resolve( initEventHandlers( result ) );
		}
        ...
        function setNewDivValue( val ) {
        	// TODO Should resolve errors thrown bellow...
        	if ( typeof currentTableRow.input !== "object" ) {
        		return true;
			}

            if ( val === "" ) {
            	// TODO There is occasionally thrown an error that `currentTableRow.input` isn't a HTMLElement.
